...
import labelStyle from "./css/label.module.css"
    ...
    <div className='bg-[#F5F5F5] mx-auto mt-10 w-[500px] h-[650px] px-10 py-5 flex flex-col gap-5'>
      ...
      <div className='flex flex-col gap-4'>
        <div className='flex flex-col gap-1'>
            <label htmlFor="" className={labelStyle.label}>Name</label>
            <input type="text" placeholder='Your name' className={inputStyle.input}/>
        </div>
        <div className='flex flex-col gap-1'>
            <label htmlFor="" className={labelStyle.label}>Email</label>
            <input type="text" placeholder='youremail@gmail.com' className={inputStyle.input}/>
        </div>
        <div className='flex flex-col gap-1'>
            <label htmlFor="" className={labelStyle.label}>Phone</label>
        ...
        <div className='flex flex-col gap-1'>
            <label htmlFor="" className={labelStyle.label}>Address</label>
